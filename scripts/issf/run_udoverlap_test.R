...
#'
#' Assumes sims/sims_test_<train_key>.rds and the test-year wrangled track
...
results_sim <- readRDS(sprintf("sims/sims_test_%s.rds", train_key))
...
saveRDS(results_ud, sprintf("filters/udoverlap_test_%s.rds", train_key))
